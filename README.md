...
| 排名 | 方法 | HarmBench Acc | AdvBench Acc | Alpaca Acc | 平均 | 来源 |
|:----:|------|:------------:|:-----------:|:----------:|:----:|------|
| **1** | **Ours (V7-Full)** | **97.0%** | **97.0%** | **100%** | **98.0%** | 实测 |
| 2 | NeMo+RF | — | — | — | — | arXiv:2412.01547 |
| 3 | Ours (V7-Embed) | 82.0% | 85.0% | 98.5% | 88.5% | 实测 |
| 4 | InjecGuard | — | — | — | 83.5%* | arXiv:2410.22770 |
| 5 | GradSafe | — | — | — | — | ACL 2024 |
| — | PromptGuard (86M) | — | — | — | — | F1=0.303 on JBHub |

> \* InjecGuard 83.5% 为 PINT/BIPIA/NotInject 平均，非 HarmBench/AdvBench
>
> V7-Full 在 HarmBench 和 AdvBench 上达到 **97% 准确率**，Alpaca **100%**。现有轻量方法（NeMo、PromptGuard、InjecGuard）均**未在这些数据集上报告结果**。

#### V7-Full 完整数据集准确率

| 数据集 | 类型 | 样本 | V7-Full Acc | V7-Embed Acc |
|--------|------|------|:-----------:|:------------:|
| HarmBench | 有害行为 | 100 | **97%** | 82% |
| AdvBench | 有害指令 | 100 | **97%** | 85% |
| Alpaca | 常规指令 | 100 | **100%** | 98.5% |
| Everyday-Conv | 日常对话 | 100 | **99%** | — |
| JBB-Behaviors | 越狱行为 | 100 | **88%** | — |
| WildChat | 真实对话 | 100 | **88%** | — |
| GCG attacks | 梯度攻击 | 100 | **96%** | 84% |
| PAIR attacks | 语义越狱 | 86 | 62% | 48% |

#### 综合优势总结

| 指标 | V7 排名 | V7 数据 | 最优对手 | 备注 |
|------|:-------:|--------|---------|------|
| HarmBench/AdvBench 准确率 | **#1** | **97%** | 无人报告 | 唯一有数据的轻量方法 |
| Alpaca 准确率 | **#1** | **100%** | — | 正常指令零误报 |
| 表征维度 | **#1** | 19d | NeMo 768d | 最小表征空间，5%压缩率 |
| Alpaca FPR | **#1** | 1.5% | PG 50.7% | 是 PromptGuard 的 1/34 |
